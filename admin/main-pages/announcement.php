...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'create') {
        ...
        if (!empty($_FILES['attachment']['name'])) {
            ...
            $attachments = json_encode(['file' => $fileName, 'type' => $file['type']]);
        }
        
        $status = $scheduledAt ? 'scheduled' : 'active';
        
        $stmt = $pdo->prepare('
            INSERT INTO announcements (title, body, author_id, priority, status, target_audience, attachments, scheduled_at)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        ');
      ...
      <div class="card mb-4">
        <div class="card-body">
          <form method="get" class="row g-3">
            <div class="col-md-6">
              <label class="form-label">Search by Title or Content</label>
      ...
      <div class="modal-content">
        ...
        <form id="createAnnouncementForm" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label class="form-label">Upload Attachment (Image or PDF)</label>
            ...
            <div class="mb-3">
              <label class="form-label">Schedule for Future (Optional)</label>

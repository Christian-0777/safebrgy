...
$reports = [
  ["title" => "Motor Accident", "date" => "March 23, 2026, 5:26 AM", "status" => "Open"],
  ["title" => "Fire Incident", "date" => "March 23, 2026, 5:26 AM", "status" => "Open"],
  ["title" => "Blotter", "date" => "March 23, 2026, 5:26 AM", "status" => "Open"],
  ["title" => "Water Leakage", "date" => "March 23, 2026, 5:26 AM", "status" => "Open"]
];
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <tbody id="reportsTable">
          <?php foreach ($reports as $r): ?>
            <tr>
              ...
              <td><a href="view_report.php?title=<?php echo urlencode($r['title']); ?>" class="btn btn-sm btn-outline-info">View</a></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
